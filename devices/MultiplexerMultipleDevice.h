...
#ifndef SENSOR_MONITOR_MULTIPLEXER_MULTIPLE_DEVICE_H
#define SENSOR_MONITOR_MULTIPLEXER_MULTIPLE_DEVICE_H
...
#endif //SENSOR_MONITOR_MULTIPLEXER_MULTIPLE_DEVICE_H
